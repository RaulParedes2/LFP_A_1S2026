...
std::string Token::tokenTypeToString(TokenType type)
{
    ...
    case TokenType::DIAGNOSTICOS:
        return "DIAGNOSTICOS";
    case TokenType::PACIENTE:
        return "PACIENTE";
    case TokenType::MEDICO:
        return "MEDICO";
    case TokenType::CITA:
        return "CITA";
    case TokenType::DIAGNOSTICO:
        return "DIAGNOSTICO";
    case TokenType::CON:
        return "CON";
    case TokenType::ATRIBUTO:
        return "ATRIBUTO"; // <-- AGREGAR ESTA LÍNEA
