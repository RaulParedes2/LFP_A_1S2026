...
namespace TaskScript
{
    ...
    // Inicializar el contador estatico
    int ASTNode::dotNodeCounter = 0;
    ...
    std::string ASTNode::toGraphViz() const
    {
        std::stringstream ss;
        int currentId = dotNodeCounter++;
